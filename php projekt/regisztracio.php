        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
            ...
            if ($jelszo != $jelszo2) {
                ...
                $to = 'botardoraphp@gmail.com';
                $from = 'botardoraphp@gmail.com';
                $from_name = 'Botar Dora';
                $subject = 'Sikeres regisztracio';
                $message = 'Sikeresen regisztráltál a Erdélyi Magyar Informatikusok konferenciájának honlapjára. Itt minden információt megkapsz, ami az eseménnyel kapcsolatos. <br> Üdvözlettel, a szervező csapat.';
                ...
                // }
                if ($resultcheck[0] > 0){
                    header("location: regisztracio.php?message=<div class='alert alert-danger'>Ez a felhasználónév már létezik az adatbázisban, regisztráltak vele.</div>");
                } else{	
